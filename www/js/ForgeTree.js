            ...
            if (data != null && data.node != null && data.node.type == 'object') {
                ...
                getForgeToken(function (access_token) {
                    jQuery.ajax({
                        ...
                        ,
                        error: function (err) {
                            var msgButton = 'This file is not translated yet! <button class="btn btn-xs btn-info" onclick="tr' +
                                    'anslateObject()"><span class="glyphicon glyphicon-eye-open"></span> Start transl' +
                                    'ation</button>'
